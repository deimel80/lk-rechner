...
const hypeMessages = {
  normal: ["DU BIST EINE MASCHINE.","HEUTE HAT DER SCHLÄGER GESPROCHEN.","DIE LK WAR NUR EINE ZAHL.","COURT BETRETEN. PUNKTE MITGENOMMEN.","RESPEKTLOS GUT GESPIELT."],
  strong: ["LK-RÄUBER AUF FREIEM FUSS.","AB HEUTE NUR NOCH VORHANDSTRAHL.","DER GEGNER HATTE DIE LK. DU HATTEST DIE ANTWORT.","DU WARST HEUTE DAS PROBLEM.","VON WEGEN AUSSENSEITER."],
  monster: ["DAS WAR KEIN SIEG. DAS WAR EINE DEMONTAGE.","AUF DEM SPIELBERICHT STEHT EIN VERBRECHEN.","DU HAST DIE LK NICHT VERBESSERT. DU HAST SIE ENTFÜHRT.","HEUTE GAB ES NUR OPFER.","DAS WAR EIN LK-ÜBERFALL."]
};
